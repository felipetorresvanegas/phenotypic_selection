...
```{r}
data_phenotypes_knivsasen_2021 <- read_rds(paste0(here::here("GitHub/Data/Data_Phenotypes_Knivsasen_2021.rds")))
```
...
```{r}
data_phenotypes_knivsasen_2022 <- read_rds(paste0(here::here("GitHub/Data/Data_Phenotypes_Knivsasen_2022.rds")))
```
...
```{r}
data_phenotypes_veberod_2022 <- read_rds(paste0(here::here("GitHub/Data/Data_Phenotypes_Veberod_2022.rds")))
```
...
saveRDS(data_selection_gradients_mean_variance, 
        file = paste0(here::here("GitHub/Data/Selection_Gradients_Error_Corrected_Spatio_Temporal.rds")))
```
...
saveRDS(data_selection_gradients_mean_variance_K21_K22_V22, 
        file = paste0(here::here("GitHub/Data/Selection_Gradients_Error_Corrected.rds")))
```