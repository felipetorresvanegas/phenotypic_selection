---
title: "Phenotypic Selection on Floral Traits: Knivsåsen 2021"
---
...
```{r}
data_knivsasen_2021 <- readxl::read_excel(paste0(here::here("GitHub/Data/Selection_2022_15-02-23.xlsx")), sheet = "Knivsasen_2021")
```
...
```{r}
saveRDS(data_knivsasen_2021, 
        file = paste0(here::here("GitHub/Data/Data_Phenotypes_Knivsasen_2021.rds")))
```
...
```{r}
data_knivsasen_2021_selection_models_linear <- nlme::lme(Relative_Fruit_Yield_Total_Fruits ~
...
```{r}
data_knivsasen_2021_selection_models_quadratic <- nlme::lme(Relative_Fruit_Yield_Total_Fruits ~
                                                              Stem_Height_Mean_Centred +
                                                              Corolla_Diameter_Mean_Centred + 
                                                              Tube_Width_Mean_Centred +
                                                              Tube_Length_Mean_Centred +
...
```{r}
data_knivsasen_2021_models_performance <- compare_performance(data_knivsasen_2021_selection_models_linear,
                                                              data_knivsasen_2021_selection_models_quadratic,
...
data_knivsasen_2021_selection_gradients <-
  data.frame(Trait = c("Stem_Height",
             ...
             Estimate = c(data_knivsasen_2021_selection_models_linear$coefficients$fixed[[2]],
                          data_knivsasen_2021_selection_models_linear$coefficients$fixed[[3]],
                          data_knivsasen_2021_selection_models_linear$coefficients$fixed[[4]],
                          data_knivsasen_2021_selection_models_linear$coefficients$fixed[[5]],
                          data_knivsasen_2021_selection_models_linear$coefficients$fixed[[6]],
                          data_knivsasen_2021_selection_models_linear$coefficients$fixed[[7]],
                          data_knivsasen_2021_selection_models_linear$coefficients$fixed[[8]]),
             ...
             p = c(summary(data_knivsasen_2021_selection_models_linear)$tTable[,"p-value"][[2]],
                   summary(data_knivsasen_2021_selection_models_linear)$tTable[,"p-value"][[3]],
                   summary(data_knivsasen_2021_selection_models_linear)$tTable[,"p-value"][[4]],
                   summary(data_knivsasen_2021_selection_models_linear)$tTable[,"p-value"][[5]],
                   summary(data_knivsasen_2021_selection_models_linear)$tTable[,"p-value"][[6]],
                   summary(data_knivsasen_2021_selection_models_linear)$tTable[,"p-value"][[7]],
                   summary(data_knivsasen_2021_selection_models_linear)$tTable[,"p-value"][[8]]))
```
...
data_knivsasen_2021_selection_gradients <- data_knivsasen_2021_selection_gradients %>% 
  mutate(Significant = ifelse(p >= 0.05 & p <= 0.10, paste0(expression("\u2020")),
                              ifelse(data_knivsasen_2021_selection_gradients$p < 0.05 & data_knivsasen_2021_selection_gradients$p > 0.01, "*",
                                     ifelse(data_knivsasen_2021_selection_gradients$p < 0.01 & data_knivsasen_2021_selection_gradients$p > 0.001, "**",
                                            ifelse(data_knivsasen_2021_selection_gradients$p < 0.001, "***", "")))))
```
...
```{r}
saveRDS(data_knivsasen_2021_selection_gradients, 
        file = paste0(here::here("GitHub/Data/Selection_Gradients_Knivsasen_2021.rds")))
```