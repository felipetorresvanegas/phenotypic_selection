...
```{r}
data_knivsasen_2022 <- readxl::read_excel(paste0(here::here("GitHub/Data/Selection_2022_15-02-23.xlsx")), sheet = "Knivsasen_2022")
```
...
```{r}
saveRDS(data_selection_gradients, file = paste0(here::here("GitHub/Data/Selection_Gradients_Plant_Level.rds")))
```